...
namespace GappFilePerms
{
    public class MplGoogleDriveHelper
    {
        ...
        public File uploadFileInFolder(DriveService service, string c_directory)
        {
            ...
            for (int indexOfFile = 0; indexOfFile < 6; indexOfFile++)
            {
                fileMetadata.Name = "Rebook"+indexOfFile+".jpg";
                using (var stream = new System.IO.FileStream(@"C:/Users/MY PC/Documents/" + indexOfFile + ".jpg",
        ...
        public string DownloadFile(DriveService service, string fileId)
        {
            ...
            using (var fileStream = System.IO.File.Create(@"C:/Users/MY PC/Documents/" + setFileName + fileId + ".jpg"))
            {
                incrementMethod();
